...
[FLAG: stale] - **Brittle Linter Masking of AST Strings**:  Do not delete extracted payload bodies to appease `unused_variable` linters if they are needed to organically assert structural trace mutations.
