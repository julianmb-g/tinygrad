...
* [FLAG: stale] **IPC Authentic Testing**: Ensure that IPC worker communication tests allocate genuine `shared_memory.SharedMemory` objects and simulate authentic worker payloads, rather than asserting on mock primitive values.
