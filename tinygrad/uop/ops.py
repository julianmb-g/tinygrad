...
python_alu: dict[Ops, Callable]  = {
  ...
  Ops.SIN: lambda x: math.sin(x) if not math.isinf(x) else math.nan, Ops.POW: safe_pow, Ops.TRUNC: lambda x: math.nan if isinstance(x, float) and (math.isnan(x) or math.isinf(x)) else math.trunc(x),
